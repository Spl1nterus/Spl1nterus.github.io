...
jQuery(function($){
 ...
 $(".full-text__btn").on('click', function(e) {
  e.preventDefault();
   ...
   $(".offer__item--fade").css("opacity", "1");
    $(".offer__base-text").css("display", "none");
    $(".offer__base-text").css("opacity", "0");
    $(".offer__full-text").css("display", "block");
    $(".offer__full-text").css("opacity", "1"); 
}); 
  ...
  e.preventDefault();
   ...
   $(".offer__item--fade").css("opacity", "0.6");
    $(".offer__full-text").css("display", "none");
    $(".offer__full-text").css("opacity", "0"); 
    $(".offer__base-text").css("display", "block");
    $(".offer__base-text").css("opacity", "1");
}); 
